...
stoppingConditionSpec$ is an Association specifying conditions (e.g., 'MaxEvents') that, if satisfied, will cause the \
evaluation to stop immediately. The list of choices can be obtained with StoppingConditionParameters[Head[system$]].
";
