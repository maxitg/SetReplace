...
WolframModelEvolutionObject::usage = usageString[
	...
	"\n",
	"WolframModelEvolutionObject[`...`][\"SetAfterEvent\", `s`] yields the set after `s` ",
	"substitution events.",
	"\n",
...
propertyEvaluate[WolframModelEvolutionObject[data_ ? evolutionDataQ], caller_, "Rules"] :=
	data[$rules]
...
propertyEvaluate[
		...
		s_Integer] := 0 /;
	With[{eventsCount =
			propertyEvaluate[WolframModelEvolutionObject[data], caller, "EventsCount"]},
...
propertyEvaluate[
			...
			g_Integer] /;
		- propertyEvaluate[
			WolframModelEvolutionObject[data], caller, "GenerationsCount"] - 1 <= g < 0 :=
	propertyEvaluate[
		WolframModelEvolutionObject[data],
		caller,
		"Generation",
...
propertyEvaluate[
		WolframModelEvolutionObject[data_ ? evolutionDataQ], caller_, "AtomsCountFinal"] :=
	Length[Union @ Cases[
		propertyEvaluate[WolframModelEvolutionObject[data], caller, "SetAfterEvent", -1],
		_ ? AtomQ,
		All]]
...
propertyEvaluate[
		WolframModelEvolutionObject[data_ ? evolutionDataQ], caller_, "AtomsCountTotal"] :=
